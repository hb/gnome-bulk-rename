...
PREVIEWS_COLUMNS = (str, object, float, bool, str)
PREVIEWS_COLUMN_SHORT_DESCRIPTION = 0
PREVIEWS_COLUMN_PREVIEW = 1
PREVIEWS_COLUMN_PRIORITY = 2
PREVIEWS_COLUMN_VISIBLE = 3
PREVIEWS_COLUMN_SHORT_DESCRIPTION_MARKUP = 4
